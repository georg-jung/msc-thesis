\documentclass[
	...
	accentcolor=2d,% Auswahl der Akzentfarbe
...
\Metadata{
	title=Gesichtserkennung verstehen: Eine interaktive Lernplattform,
    subject=Hier kommt der Untertitel oder Abstract rein,
	author=Georg Jung,
    URLlink=https://github.com/georg-jung/msc-thesis/,
    keywords={Gesichtserkennung \sep Face Detection \sep Face Recognition \sep TU Darmstadt \sep Georg Jung \sep Master Thesis}
}

\title{Gesichtserkennung verstehen: Eine interaktive Lernplattform}
\subtitle{Breaking Barriers to Face Recognition: An Interactive Learning Platform}
\author{Georg Jung}%optionales Argument ist die Signatur,
\reviewer{Dr.-Ing. Guido Rößling \and M.Sc. Leon Böck}%Gutachter
...
\affidavit[affidavit=digital]% oder \affidavit[digital] falls eine rein digitale Abgabe vorgesehen ist.
